...
var jsdocOl3 = require('/opt/apiv3/.build/jsdocOl3.js');
    ...
    if (items.length) {
        ...
        items.forEach(function(item) {
            ...
            if ( !hasOwnProp.call(item, 'longname') ) {
                ...
                var link = '<li>' + linktoFn(item.longname, item.name.replace(/^module:/, '')) + '</li>';
                // fix for link to enum file
                link = link.replace('href="module:', 'href="./module:');
                itemsNav += link;
