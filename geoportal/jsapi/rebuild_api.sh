...
node_modules/url-polyfill/url-polyfill.min.js > /app/geoportailv3_geoportal/static-ngeo/build/concatenated.js
cat /app/geoportailv3_geoportal/static-ngeo/build/apiv3.js > /app/geoportailv3_geoportal/static-ngeo/build/apiv3.js
