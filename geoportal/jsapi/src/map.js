...
export default class Map extends OpenLayersMap {
  ...
  constructor(options) {
    ...
    this.grantedUrls = ['visitluxembourg.com', 'mullerthal-trail.lu', 'traveltrade.visitluxembourg.com', 'visit-eislek.lu', 'visitguttland.lu',
      ...
      'mae.lu', 'gouvernement.lu', 'meteolux.lu'];
  ...
  getGeometryArea(geometry) {
    return getSphericalArea(geometry);
  }
  ...
  getGeometryLength(geometry) {
    return getSphericalLength(geometry);
  }
