# Copy past from c2cgeoportal_admin.views.layer_wms except:
#  - All references to LuxLayerExternalWMS and lux_layer_external_wms
...
base_schema.add_unique_validator(LuxLayerExternalWMS.name, LuxLayerExternalWMS.id)
...
class LuxLayerExternalWMSViews(DimensionLayerViews):
    ...
    _id_field = 'id'
    _model = LuxLayerExternalWMS
    _base_schema = base_schema

    def _base_query(self):
        return super()._base_query(
            self._request.dbsession.query(LuxLayerExternalWMS).distinct().
