...
get('EPSG:32632').setExtent([166021.44, 0.00, 833978.55, 9329005.18]);

proj4.defs('EPSG:32631', '+proj=utm +zone=31 +datum=WGS84 +units=m +no_defs');
get('EPSG:32631').setExtent([166021.44, 0.00, 833978.55, 9329005.18]);
...
proj4.defs('EPSG:2169',
    ...
    '+units=m +no_defs"');
get('EPSG:2169').setExtent([48225.17, 56225.60, 105842.04, 139616.40]);
