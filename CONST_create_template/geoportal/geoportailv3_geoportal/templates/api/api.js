...
document.write('<scr' + 'ipt type="text/javascript" src="'
        + "${request.static_url('geoportailv3_geoportal:static/build/api.js', _query=url_params)}" + '"></scr' + 'ipt>');
document.write('<scr' + 'ipt type="text/javascript" src="'
        + "${request.static_url('geoportailv3_geoportal:static/build/api-lang-%s.js' % lang, _query=url_params)}" + '"></scr' + 'ipt>');
document.write('<link rel="stylesheet" type="text/css" href="'
        + "${request.static_url('geoportailv3_geoportal:static/build/api.css', _query=url_params)}" + '" />');
% endif
