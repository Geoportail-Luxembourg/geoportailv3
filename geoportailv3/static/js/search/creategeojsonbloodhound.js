...
goog.provide('app.CreateGeoJSONBloodhound');
 ...
 */
app.createGeoJSONBloodhound = function(options, opt_featureProjection,
    opt_dataProjection) {
...
app.module.value('appCreateGeoJSONBloodhound', app.createGeoJSONBloodhound);
