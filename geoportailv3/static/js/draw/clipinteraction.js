...
goog.require('ol.interaction.SegmentDataType');
 ...
 * @api
 */
app.ClipLine = function(options) {

  goog.base(this, {
    handleDownEvent: app.ClipLine.handleDownEvent_,
    handleEvent: app.ClipLine.handleEvent,
    handleUpEvent: app.ClipLine.handleUpEvent_
  });
  ...
  this.overlay_ = new ol.layer.Vector({
    ...
    style: options.style ? options.style :
        app.ClipLine.getDefaultStyleFunction(),
...
goog.inherits(app.ClipLine, ol.interaction.Pointer);
 ...
 * @private
 */
app.ClipLine.prototype.addFeature_ = function(feature) {
 ...
 * @private
 */
app.ClipLine.prototype.removeFeature_ = function(feature) {
 ...
 * @private
 */
app.ClipLine.prototype.removeFeatureSegmentData_ = function(feature) {
 ...
 * @inheritDoc
 */
app.ClipLine.prototype.setMap = function(map) {
 ...
 * @private
 */
app.ClipLine.prototype.handleFeatureAdd_ = function(evt) {
 ...
 * @private
 */
app.ClipLine.prototype.handleFeatureChange_ = function(evt) {
 ...
 * @private
 */
app.ClipLine.prototype.handleFeatureRemove_ = function(evt) {
 ...
 * @private
 */
app.ClipLine.prototype.writeLineStringGeometry_ = function(feature, geometry) {
 ...
 * @private
 */
app.ClipLine.prototype.createOrUpdateVertexFeature_ = function(coordinates) {
 ...
 * @private
 */
app.ClipLine.compareIndexes_ = function(a, b) {
 ...
 * @private
 */
app.ClipLine.handleUpEvent_ = function(evt) {
 ...
 * @private
 */
app.ClipLine.handleDownEvent_ = function(evt) {
  ...
  if (vertexFeature) {
    ...
    segmentDataMatches.sort(app.ClipLine.compareIndexes_);
 ...
 * @api
 */
app.ClipLine.handleEvent = function(mapBrowserEvent) {
 ...
 * @inheritDoc
 */
app.ClipLine.prototype.setActive = function(active) {
  this.handlingDownUpSequence = false;
 ...
 * @private
 */
app.ClipLine.prototype.handlePointerMove_ = function(evt) {
 ...
 */
app.ClipLine.getDefaultStyleFunction = function() {
