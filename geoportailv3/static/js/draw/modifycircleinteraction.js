 ...
 * @api
 */
app.ModifyCircle = function(options) {

  goog.base(this, {
    handleDownEvent: app.ModifyCircle.handleDownEvent_,
    handleDragEvent: app.ModifyCircle.handleDragEvent_,
    handleEvent: app.ModifyCircle.handleEvent,
    handleUpEvent: app.ModifyCircle.handleUpEvent_
  });
  ...
  this.overlay_ = new ol.layer.Vector({
    ...
    style: options.style ? options.style :
        app.ModifyCircle.getDefaultStyleFunction(),
 ...
 * @private
 */
app.ModifyCircle.prototype.removeFeature_ = function(feature) {
 ...
 * @private
 */
app.ModifyCircle.prototype.removeFeatureSegmentData_ = function(feature) {
 ...
 * @inheritDoc
 */
app.ModifyCircle.prototype.setMap = function(map) {
 ...
 * @private
 */
app.ModifyCircle.prototype.writeCircleGeometry_ = function(feature, geometry) {
 ...
 * @private
 */
app.ModifyCircle.compareIndexes_ = function(a, b) {
 ...
 * @this {app.ModifyCircle}
 * @private
 */
app.ModifyCircle.handleDownEvent_ = function(evt) {
  ...
  if (vertexFeature) {
    ...
    segmentDataMatches.sort(app.ModifyCircle.compareIndexes_);
 ...
 * @private
 */
app.ModifyCircle.handleDragEvent_ = function(evt) {
 ...
 * @private
 */
app.ModifyCircle.handleUpEvent_ = function(evt) {
  this.rBush_.clear();
 ...
 * @api
 */
app.ModifyCircle.handleEvent = function(mapBrowserEvent) {
 ...
 * @private
 */
app.ModifyCircle.prototype.handlePointerMove_ = function(evt) {
