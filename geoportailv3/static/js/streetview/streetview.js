 ...
 * @ngInject
 */
app.streetviewDirective = function(appStreetviewTemplateUrl) {
  return {
    restrict: 'E',
    scope: {
...
app.module.directive('appStreetview', app.streetviewDirective);
 ...
 * @export
 */
app.StreetviewController = function($element, $scope, ngeoFeatureOverlayMgr,
 ...
 * @private
 */
app.StreetviewController.prototype.handleLocationChange_ = function(location, oldLocation) {
 ...
 * @private
 */
app.StreetviewController.prototype.handleReadyChange_ = function(ready, oldReady) {
 ...
 * @export
 */
app.StreetviewController.prototype.createStyleFunction = function() {
 ...
 * @private
 */
app.StreetviewController.prototype.handleStreetViewServiceGetPanorama_ = function(data, status) {
 ...
 * @private
 */
app.StreetviewController.prototype.style_ = function() {
  this.features_.clear();
 ...
 * @private
 */
app.StreetviewController.prototype.handlePanoramaPositionChange_ = function() {
 ...
 */
app.StreetviewController.prototype.fromLonLat_ = function(lonLat) {
 ...
 */
app.StreetviewController.prototype.toLonLat_ = function(coordinate) {
 ...
 */
app.StreetviewController.prototype.loadGoogleapis_ = function() {
...
app.module.controller('AppStreetviewController', app.StreetviewController);
