 ...
 *
 * This file defines the "geoportailv3_desktop" Closure namespace, which is be used as
 ...
 */
goog.provide('geoportailv3.DesktopController');
goog.provide('geoportailv3_desktop');
 ...
 * @export
 */
geoportailv3.DesktopController = function($scope, $injector) {
...
ol.inherits(geoportailv3.DesktopController, gmf.AbstractDesktopController);


geoportailv3.module.controller('DesktopController', geoportailv3.DesktopController);
