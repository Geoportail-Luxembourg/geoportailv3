...
update-pots:
	...
	docker exec $(DOCKER_CONTAINER) msgcat /tmp/legends.pot /app/geoportailv3_geoportal/locale/geoportailv3_geoportal-legends.pot -o /tmp/legends2.pot
	...
	docker exec $(DOCKER_CONTAINER) msgcat /tmp/tooltips.pot /app/geoportailv3_geoportal/locale/geoportailv3_geoportal-tooltips.pot -o /tmp/tooltips2.pot
